...
# OBJECTIVE FUNCTION
# 10476 is the material cost, 9312 is the QC cost
def obj_rule(model):
    return sum( model.CTM[p]for p in model.p )+ sum( model.TTC[p] for p in model.p ) + (10476+9312)*len(model.p)
